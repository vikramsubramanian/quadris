...
enum Command {left, right, down, clockwise, counterclockwise, drop};
...
class Level {
    public:
        ...
        virtual std::vector<Command> drop() const = 0;
        virtual std::vector<Command> drop(bool) const = 0;
};
...
class Level0 : public Level {
    public:
        ...
        std::vector<Command> drop() const override;
        std::vector<Command> drop(bool) const override;
};
