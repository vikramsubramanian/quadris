...
// -------------------------------------------------------------------------------
// Next Block Decider
char Level0::nextBlock(std::mt19937 &rng, std::ifstream &file,
                       bool flag) const {
  char block;
...
bool Level0::constructiveForce() const { return false; }
...
// -------------------------------------------------------------------------------
// Next Block Decider
char Level1::nextBlock(std::mt19937 &rng, std::ifstream &file,
                       bool flag) const {
  char block;
...
// -------------------------------------------------------------------------------
// Constructive Force Decider
bool Level1::constructiveForce() const { return false; }
...
// -------------------------------------------------------------------------------
// Next Block Decider
char Level2::nextBlock(std::mt19937 &rng, std::ifstream &file,
                       bool flag) const {
  char block;
  block = nextBlock_(rng);
  return block;
...
// -------------------------------------------------------------------------------
// Constructive Force Decider
bool Level2::constructiveForce() const { return false; }
...
// -------------------------------------------------------------------------------
// Next Block Decider
char Level3::nextBlock(std::mt19937 &rng, std::ifstream &file,
                       bool random) const {
  char block;
  if (random) {
    block = nextBlock_(rng);
...
// -------------------------------------------------------------------------------
// Constructive Force Decider
bool Level3::constructiveForce() const { return false; }
...
// -------------------------------------------------------------------------------
// Next Block Decider
char Level4::nextBlock(std::mt19937 &rng, std::ifstream &file,
                       bool random) const {
  char block;
  if (random) {
    block = nextBlock_(rng);
...
// -------------------------------------------------------------------------------
// Constructive Force Decider
bool Level4::constructiveForce() const { return true; }